...
abstract class TlsServerBase extends DefaultTlsServer {

    private static final Logger LOG = LoggerFactory.getLogger(TlsServerBase.class);

    @Override
    public void notifyAlertRaised(final short alertLevel, final short alertDescription,
                                  final String message, final Throwable cause) {
        LOG.warn(String.format("Local server alert: [%s] %s, %s",
